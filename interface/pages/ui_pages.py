...
################################################################################
## Form generated from reading UI file 'pagesITHgpG.ui'
##
...
class Ui_application_pages(object):
    def setupUi(self, application_pages):
        ...
        application_pages.resize(1078, 693)
        self.page_1 = QWidget()
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label_1.setText(QCoreApplication.translate("application_pages", u"Pagina inicial", None))
